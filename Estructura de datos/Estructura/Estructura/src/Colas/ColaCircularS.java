...
public class ColaCircularS 
{
	static int max=5; // Tamano maximo de la Cola Circular
    static String colacirc[]=new String[max]; // Declaracion del arreglo para almacenar la Cola Circular
    static int frente, fin; // Inidicadores del inicio y final de la Cola Circular

    ColaCircularS() { // Constructor que inicializa el frente y el final de la Cola Circular
     frente=-1;    fin=-1;
