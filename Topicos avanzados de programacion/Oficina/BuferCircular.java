...
{
   private final int[] bufer = { -1 }; // búfer compartido
   ...
   public synchronized void establecer( int valor ) throws InterruptedException
   {
      ...
      {
         System.out.printf( "Oficina se encuentra en labor. Documento en espera.\n" );
      ...
      mostrarEstado( "Documento solicitado " + valor );
   ...
   public synchronized int obtener() throws InterruptedException
   {
      ...
      {
         System.out.printf( "Oficina no tiene tramites. Trabajadores esperan.\n" );
      ...
      mostrarEstado( "Servicio atendido " + valorLeido );
   ...
   public void mostrarEstado( String operacion )
   {
      ...
      System.out.printf( "%s%s%d)\n", operacion, 
         " (Documentos en l oficina: ", celdasOcupadas );
