...
{
   private final int[] bufer = { -1, -1 }; // búfer compartido
   ...
   public synchronized void establecer( int valor ) throws InterruptedException
   {
      ...
      {
         System.out.printf( "Ambas pistas estan ocupadas. Avion no puede aterrizar.\n" );
      ...
      mostrarEstado( "Avion de aerolinea  " + valor +" aterrizando" );
   ...
   public synchronized int obtener() throws InterruptedException
   {
      ...
      {
         System.out.printf( "Pistas vacias. No ha llegado algun avion.\n" );
      ...
      mostrarEstado( "Avion de la aerolienea " + valorLeido+" despegando" );
   ...
   public void mostrarEstado( String operacion )
   {
      ...
      System.out.printf( "%s%s%d)\n", operacion, 
         " (aviones en la pista: ", celdasOcupadas );
