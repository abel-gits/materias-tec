...
{
   private int[] bufer; // búfer compartido
   ...
   public synchronized void establecer( int valor ) throws InterruptedException
   {
      ...
      {
         System.out.printf( "Restaurante lleno. Clientes esperan.\n" );
      ...
      mostrarEstado( "Platillo solicitado " + valor );
   ...
   public synchronized int obtener() throws InterruptedException
   {
      ...
      {
         System.out.printf( "Restaurante vacio. Trabajadores esperan.\n" );
      ...
      mostrarEstado( "Platillo dado " + valorLeido );
   ...
   public void mostrarEstado( String operacion )
   {
      ...
      System.out.printf( "%s%s%d)\n", operacion, 
         " (Clientes en el restaurante ", celdasOcupadas );
